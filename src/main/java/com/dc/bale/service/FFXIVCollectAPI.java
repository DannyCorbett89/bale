...
public class FFXIVCollectAPI {
    ...
    private static final String MINIONS = BASE_URL + "/minions";
    ...
    public MinionsRS getMinions() {
        String minionsResponse = httpClient.get(MINIONS);
        return jsonMapper.toObject(minionsResponse, MinionsRS.class);
    }
}
